...
class User(db.Model):
    ...
    trainer_profile = db.relationship("Trainer", back_populates="user", uselist=False, cascade="all, delete-orphan")
    purchased_passes = db.relationship("PurchasedPass", back_populates="user", lazy="dynamic")
